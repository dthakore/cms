                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-sm-12">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-sm-12">
                                ...
                                <select id="select-box" class="form-control"><option>Select</option></select>
                                <select id="id-Rajasthan" class="form-control" for="Rajasthan" style="display: none;" name="id-Rajasthan">
                                ...
                                <select id="id-Gujarat" class="form-control" for="Gujarat" style="display: none" name="id-Gujarat">
                                    <option value="">Select</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-sm-12">
                                    ...
                                    <input id="opponent_name" value="{{$case->opponent_name}}"  type="text" class="form-control" name="opponent_name" >
