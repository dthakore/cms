    ...
    <div class="main-content">
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <a href="{{ url('admin/create') }}" class="btn-primary btn btn-round btn-success" style="float: right; margin-bottom: 20px;"><i class="fa fa-plus"></i> Create new</a>
                ...
                columns:[
...

                    {
                        title: 'Action', data: '', name: '', width: "7%", render: function ( data, type, full, meta ) {
                            ...
                            var url = "{{url('admin/view')}}/"+full['id'];
                            var urlEdit = "{{url('admin/update')}}/"+full['id'];
